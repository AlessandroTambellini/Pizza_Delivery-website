...
//  // Checkout
//  checkout.checkout = function(data, callback){
//    var acceptableMethods = ['post'];
//    if(acceptableMethods.indexOf(data.method) > -1){
//      checkout._checkout[data.method](data,callback);
//    } else {
//      callback(405);
//    }
//  }
...
//  // Required data on payload: orderId, stripeToken
//  // Optional data: none
//  checkout._checkout.post = function(data, callback){
//    // Get tokenId and userIdentifier from header
//    var token = typeof(data.headers.token) == 'string' ? data.headers.token : false;
//    var userIdentifier = typeof(data.headers.address) == 'string' ? data.headers.address : false;
...
//              if(!err && orderData){
//                if(orderData.address == userIdentifier){
...
//                        'from': 'mailgun@sandbox3190a416efd04182891524cf8725529e.mailgun.org',
//                        'to': 'alessandrotambellini03@gmail.com',
//                        'subject': 'Order: '+orderData.id+'',
//                        'text': 'Dear '+orderData.firstName+', the order with a total amout of ' + orderData.totalPrice + ' was made by yourself.'
//                    };

//                    helpers.sendRequest('https', '443', 'api.mailgun.net', 'POST', '/v3/sandbox3190a416efd04182891524cf8725529e.mailgun.org/messages',
...
//                        if(!err){
//                          callback(200, {'Congratulation: ' : 'All the actions has been completed. Your pizzas will be delivered at '+orderData.timeOfDelivery+' in this location: '+orderData.address});
//                        } else {
...
//                  });
//                } else {
//                  callback(403, {'Error': 'The address that you\'ve sent is not correct'});
//                }
//              } else {
...
//           });
//         } else {
//           callback(400, {'Error': 'The order id is wrong.'});
//         }
//       } else {
...
//    } else {
//      callback(403, {'Error': 'Missing required token in header. Please try again.'});
//    }
//  };
// Checkout
